                        ...
                        <div className="card-footer bg-transparent d-flex justify-content-between align-items-center">
                            ...
                            <div data-in-cart={isInCart ? "1" : "0"}>
                                {isInCart ? (
                                    ...
                                    <button onClick={addToCartClick} className="not-in-cart btn btn-outline-success">
                ...
                <div className="toast-fixed toast-success" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="toast-body">
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <button className="btn btn-outline-secondary btn-sm" onClick={continueShoppingClick}>
                                Продовжити покупки
                            </button>
                        </div>
                    </div>
                ...
                <div className="toast-fixed toast-warning" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="toast-body">
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <button className="btn btn-outline-secondary btn-sm" onClick={() => setAuthNotice(false)}>
                                Скасувати
                            </button>
                        </div>
                    </div>
